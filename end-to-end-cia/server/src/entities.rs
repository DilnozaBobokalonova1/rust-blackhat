    ...
    fn into(self) -> api::Job {
        api::Job {
            ...
            ephemeral_public_key: self
                ...
                .try_into()
                .expect("Invalid conversion of ephemeral_public_key in Job to api::Job"),
            nonce: self
                .nonce
                .try_into()
                .expect("Invalid conversion of nonce within Job to api::Job"),
            signature: self.signature,
            encrypted_result: self.encrypted_result,
            result_ephemeral_public_key: self.result_ephemeral_public_key.map(|v| {
                v.try_into()
                    .expect("Invalid conversion of result_ephemeral_public key in Job to api::Job")
            }),
            result_nonce: self.result_nonce.map(|v| {
                v.try_into()
                    .expect("Invalid conversion of result_nonce within Job to api::Job")
            }),
    ...
    fn into(self) -> api::Agent {
        api::Agent {
            ...
            identity_public_key: self
                .identity_public_key
                .try_into()
                .expect("Error converting identity_public_key for Agent into api::Agent"),
            public_prekey: self
                .public_prekey
                .try_into()
                .expect("Error converting public_prekey for Agent into api::Agent"),
